...
pub const enhanced = struct {
    pub const ProgressBar = @import("../../src/tui/widgets/enhanced/smart_progress.zig").SmartProgressBar;
    pub const SmartInput = @import("../../src/ui/components/smart_input.zig").SmartInput;
    pub const Notification = @import("../../src/tui/widgets/enhanced/notification.zig").Notification;
    pub const Graphics = @import("../../src/tui/widgets/enhanced/graphics.zig").GraphicsWidget;
};
