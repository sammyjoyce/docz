...
const graphics = @import("../../../src/shared/term/graphics.zig");
...
const input_handler = @import("../../src/shared/term/input/input_handler.zig");
...
pub const GraphicsShowcase = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !Self {
        ...
        var graphics_mgr = graphics.GraphicsManager.init(allocator, terminal);
        var renderer = adaptive_renderer.AdaptiveRenderer.init(allocator, &graphics_mgr, terminal);
    ...
    fn showWelcomeMessage(self: *Self) !void {
        ...
        const graphics_mode = graphics.GraphicsMode.detect(caps);
