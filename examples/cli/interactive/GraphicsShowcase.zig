...
const adaptive_renderer = @import("../../src/shared/tui/components/graphics/adaptive_renderer.zig");
const enhanced_input = @import("../../src/shared/term/input/input_handler.zig");
