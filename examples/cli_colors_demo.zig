...
pub fn main() void {
    print("\n", .{});
    print("\x1b[1m\x1b[38;2;65;132;228mDocZ CLI\x1b[0m - Improved Terminal Output\n\n", .{});

    print("\x1b[1m🎨 FEATURES:\x1b[0m\n\n", .{});
    print("  \x1b[38;2;231;76;60m❌ Error messages\x1b[0m with rich colors\n", .{});
    ...
    print("The CLI system provides rich, adaptive terminal output\n", .{});
