...
//!
//! Key components:
//! - **EnhancedInteractiveSession** - Main session controller
...
const canvas_engine = @import("../../src/shared/tui/core/canvas_engine.zig");
...
pub fn runEnhancedInteractiveSession(allocator: Allocator, agent: *agent_interface.Agent) !void {
    ...
    const session = try EnhancedInteractiveSession.init(allocator, agent, session_config);
