...
pub fn meetsWCAG_AA(fg: RGB, bg: RGB, large_text: bool) bool {
...
pub fn meetsWCAG_AAA(fg: RGB, bg: RGB, large_text: bool) bool {
    const ratio = contrastRatio(fg, bg);
...
test "WCAG contrast calculations" {
    ...
    try std.testing.expect(meetsWCAG_AAA(white, black, false));
    try std.testing.expect(meetsWCAG_AAA(white, black, true));
}
