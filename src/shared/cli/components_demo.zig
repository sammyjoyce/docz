...
pub fn main() !void {
    ...
    // Test ProgressBar (non-interactive)
    try demonstrateProgressBar(allocator, stdout);
    ...
    try stdout.writeAll("• SelectMenu - Mouse-enabled selection menus\n");
...
fn demonstrateProgressBar(allocator: std.mem.Allocator, writer: anytype) !void {
