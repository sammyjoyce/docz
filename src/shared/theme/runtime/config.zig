...
pub const Settings = struct {
    ...
    themePreferences: std.StringHashMap(Preference),
    ...
    pub fn init(allocator: std.mem.Allocator) Settings {
        return .{
            ...
            .themePreferences = std.StringHashMap(Preference).init(allocator),
        };
    }
    ...
    pub fn fromZon(allocator: std.mem.Allocator, content: []const u8) !Settings {
        _ = content;
        // TODO: Implement ZON parsing
        return Settings.init(allocator);
    }
};
