...
pub const Theme = struct {
    // Primary colors
    background: ansi_color.RgbColor,
    foreground: ansi_color.RgbColor,

    // Accent colors
    primary: ansi_color.RgbColor,
    secondary: ansi_color.RgbColor,
    success: ansi_color.RgbColor,
    warning: ansi_color.RgbColor,
    danger: ansi_color.RgbColor,
    info: ansi_color.RgbColor,

    // UI element colors
    border: ansi_color.RgbColor,
    highlight: ansi_color.RgbColor,
    muted: ansi_color.RgbColor,

    // Syntax highlighting colors (for code display)
    syntax_comment: ansi_color.RgbColor,
    syntax_keyword: ansi_color.RgbColor,
    syntax_string: ansi_color.RgbColor,
    syntax_number: ansi_color.RgbColor,
    syntax_operator: ansi_color.RgbColor,
    syntax_function: ansi_color.RgbColor,

    /// Convert theme colors to ANSI 256-color palette
    pub fn toAnsi256(self: Theme) Ansi256Theme {
        return Ansi256Theme{
            .background = ansi_color.rgbToAnsi256(self.background),
            .foreground = ansi_color.rgbToAnsi256(self.foreground),
            .primary = ansi_color.rgbToAnsi256(self.primary),
            .secondary = ansi_color.rgbToAnsi256(self.secondary),
            .success = ansi_color.rgbToAnsi256(self.success),
            .warning = ansi_color.rgbToAnsi256(self.warning),
            .danger = ansi_color.rgbToAnsi256(self.danger),
            .info = ansi_color.rgbToAnsi256(self.info),
            .border = ansi_color.rgbToAnsi256(self.border),
            .highlight = ansi_color.rgbToAnsi256(self.highlight),
            .muted = ansi_color.rgbToAnsi256(self.muted),
            .syntax_comment = ansi_color.rgbToAnsi256(self.syntax_comment),
            .syntax_keyword = ansi_color.rgbToAnsi256(self.syntax_keyword),
            .syntax_string = ansi_color.rgbToAnsi256(self.syntax_string),
            .syntax_number = ansi_color.rgbToAnsi256(self.syntax_number),
            .syntax_operator = ansi_color.rgbToAnsi256(self.syntax_operator),
            .syntax_function = ansi_color.rgbToAnsi256(self.syntax_function),
        };
    }
