...
const notification_mod = @import("../../tui/notifications.zig");
...
pub const OAuthWizardPro = struct {
    ...
    fn render(self: *Self) !void {
        ...
        try self.modal_manager.render(self.renderer, Render{
...
pub fn runOAuthWizard(allocator: std.mem.Allocator, tm: *ThemeManager) !oauth.Credentials {
    ...
    // Create and run advanced wizard
    var wizard = try OAuthWizardPro.init(allocator, renderer, tm);
    defer wizard.deinit();
