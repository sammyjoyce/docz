...
pub const EnhancedUIDemo = struct {
    ...
    fn showWelcomeScreen(self: *Self) !void {
        ...
        const title_style = shared.createTextStyle(
            shared.Colors.BRIGHT_BLUE, 
            true
        );
    ...
    fn demonstrateCapabilities(self: *Self) !void {
        ...
        try self.ui_context.terminal.hyperlink(
            "https://github.com/your-project", 
            "🔗 Visit our GitHub repository",
            shared.createTextStyle(shared.Colors.BRIGHT_BLUE, false)
        );
        try self.ui_context.terminal.printf("\n\n", .{}, null);
    ...
    fn showProgressDemo(self: *Self) !void {
        ...
        for (styles, style_names) |style, name| {
            ...
            while (progress <= 1.0) {
                ...
                const ctx = self.ui_context.createRenderContext(shared.Rect{ 
            ...
            const final_ctx = self.ui_context.createRenderContext(shared.Rect{ 
                .x = 0, .y = 0, .width = 80, .height = 24 
            });
    ...
    fn showInputDemo(self: *Self) !void {
        ...
        input_component.setBounds(shared.Rect{ 
            .x = 2, 
            .y = 8, 
            .width = 60, 
            .height = 5 
