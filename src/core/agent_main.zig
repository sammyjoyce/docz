//! Standardized agent main entry point that all agents can use.
...
/// Standardized main function for agents.
/// Agents should call this from their main.zig with their specific spec.
pub fn runAgent(spec: engine.AgentSpec) !void {
    ...
    try engine.runWithOptions(gpa, options, spec);
}
