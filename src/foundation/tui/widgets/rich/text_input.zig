...
pub const TextInput = struct {
    ...
    fn registerEventHandlers(self: *TextInput) !void {
        // Focus events
        const focus_handler = input_system.FocusHandler{
            .func = struct {
                fn handle(widget_ptr: *TextInput) *const fn (bool) void {
                    return struct {
        ...
        const paste_handler = input_system.PasteHandler{
            .func = struct {
                fn handle(widget_ptr: *TextInput) *const fn ([]const u8) void {
                    return struct {
        ...
        const click_handler = input_system.ClickHandler{
            .func = struct {
                fn handle(widget_ptr: *TextInput) *const fn (input_system.ClickEvent) bool {
                    return struct {
        ...
        const drag_handler = input_system.DragHandler{
            .func = struct {
                fn handle(widget_ptr: *TextInput) *const fn (input_system.DragEvent) bool {
                    return struct {
    ...
    /// Handle focus change
    fn onFocusChange(self: *TextInput, has_focus: bool) void {
    ...
    /// Handle paste event
    fn onPaste(self: *TextInput, paste_content: []const u8) void {
    ...
    /// Handle mouse click
    fn onClick(self: *TextInput, event: input_system.ClickEvent) bool {
    ...
    fn onDrag(self: *TextInput, event: input_system.DragEvent) bool {
    ...
    pub fn handleKeyEvent(self: *TextInput, event: input_system.InputEvent) bool {
    ...
    pub fn render(self: *TextInput, renderer: *tui.Renderer) !void {
    ...
    fn isPointInBounds(self: *const TextInput, pos: input_system.Position) bool {
    ...
    fn calculateTextPosition(self: *const TextInput, pos: input_system.Position) usize {
    ...
    fn hasSelection(self: *const TextInput) bool {
        return self.selection_start != null and self.selection_end != null and
            self.selection_start.? != self.selection_end.?;
    }

    fn clearSelection(self: *TextInput) void {
        self.selection_start = null;
        self.selection_end = null;
    }

    fn setCursorPosition(self: *TextInput, pos: usize) void {
    ...
    fn replaceSelection(self: *TextInput, text: []const u8) !void {
    ...
    fn selectWordAt(self: *TextInput, pos: usize) void {
    ...
    fn getPasswordDisplay(self: *const TextInput) ![]u8 {
        const password_chars = try self.allocator.alloc(u8, self.content.items.len);
        @memset(password_chars, '*');
        return password_chars;
    }

    fn renderWithSelection(self: *TextInput, renderer: *tui.Renderer, area: tui.Bounds, text: []const u8) !void {
        const start = @min(self.selection_start.?, self.selection_end.?);
        const end = @max(self.selection_start.?, self.selection_end.?);
    ...
    fn triggerChange(self: *TextInput) void {
        self.is_dirty = true;
