...
const ansi256_to_16 = [256]BasicColor{
    ...
    .black,          .blue,           .blue,           .blue,           .bright_blue,    .bright_blue,    .green,          .cyan,
    .blue,           .blue,           .bright_blue,    .bright_blue,    .green,          .green,          .cyan,           .blue,
    .bright_blue,    .bright_blue,    .green,          .green,          .green,          .cyan,           .bright_blue,    .bright_blue,
    .bright_green,   .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .bright_blue,    .bright_green,   .bright_green,
    .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .red,            .magenta,        .blue,           .blue,
    .bright_blue,    .bright_blue,    .yellow,         .white,          .blue,           .blue,           .bright_blue,    .bright_blue,
    .green,          .green,          .cyan,           .blue,           .bright_blue,    .bright_blue,    .green,          .green,
    .green,          .cyan,           .bright_blue,    .bright_blue,    .bright_green,   .bright_green,   .bright_green,   .bright_cyan,
    .bright_cyan,    .bright_blue,    .bright_green,   .bright_green,   .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,
    .red,            .red,            .magenta,        .blue,           .bright_blue,    .bright_blue,    .red,            .red,
    .magenta,        .magenta,        .bright_blue,    .bright_blue,    .yellow,         .yellow,         .white,          .cyan,
    .bright_blue,    .bright_blue,    .green,          .green,          .green,          .cyan,           .bright_blue,    .bright_blue,
    .bright_green,   .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .bright_blue,    .bright_green,   .bright_green,
    .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .red,            .red,            .red,            .magenta,
    .bright_blue,    .bright_blue,    .red,            .red,            .red,            .magenta,        .magenta,        .bright_blue,
    .red,            .red,            .red,            .magenta,        .magenta,        .bright_magenta, .yellow,         .yellow,
    .yellow,         .white,          .cyan,           .bright_blue,    .bright_green,   .bright_green,   .bright_green,   .bright_cyan,
    .bright_cyan,    .bright_blue,    .bright_green,   .bright_green,   .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,
    .bright_red,     .bright_red,     .bright_red,     .bright_magenta, .bright_blue,    .bright_blue,    .bright_red,     .bright_red,
    .bright_red,     .bright_magenta, .bright_magenta, .bright_blue,    .bright_red,     .bright_red,     .bright_red,     .bright_magenta,
    .bright_magenta, .bright_magenta, .bright_yellow,  .bright_yellow,  .bright_yellow,  .bright_white,   .bright_cyan,    .bright_blue,
    .bright_green,   .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .bright_blue,    .bright_green,   .bright_green,
    .bright_green,   .bright_green,   .bright_cyan,    .bright_cyan,    .bright_red,     .bright_red,     .bright_red,     .bright_red,
    .bright_magenta, .bright_blue,    .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_magenta, .bright_magenta,
    .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_magenta, .bright_magenta, .bright_red,     .bright_red,
    .bright_red,     .bright_red,     .bright_magenta, .bright_magenta,

    // Fill remaining cube colors (need to complete the 6x6x6 = 216 colors)
    .bright_red,     .bright_red,     .bright_red,     .bright_red,
    .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_red,     .bright_red,
