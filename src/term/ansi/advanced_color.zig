...
/// Uses sophisticated algorithm from Charmbracelet X with better color matching
...
/// Based on Charmbracelet X implementation
...
/// Based on Charmbracelet X with improved color mapping
...
// Complete ANSI 256-color palette with accurate RGB values from Charmbracelet X
...
const ansi256_palette = [256]RGBColor{
    ...
    RGBColor.init(0x5F, 0x00, 0x00), RGBColor.init(0x5F, 0x00, 0x5F), RGBColor.init(0x5F, 0x00, 0x87), RGBColor.init(0x5F, 0x00, 0xAF), RGBColor.init(0x5F, 0x00, 0xD7), RGBColor.init(0x5F, 0x00, 0xFF),
    RGBColor.init(0x5F, 0x5F, 0x00), RGBColor.init(0x5F, 0x5F, 0x5F), RGBColor.init(0x5F, 0x5F, 0x87), RGBColor.init(0x5F, 0x5F, 0xAF), RGBColor.init(0x5F, 0x5F, 0xD7), RGBColor.init(0x5F, 0x5F, 0xFF),
    RGBColor.init(0x5F, 0x87, 0x00), RGBColor.init(0x5F, 0x87, 0x5F), RGBColor.init(0x5F, 0x87, 0x87), RGBColor.init(0x5F, 0x87, 0xAF), RGBColor.init(0x5F, 0x87, 0xD7), RGBColor.init(0x5F, 0x87, 0xFF),
    RGBColor.init(0x5F, 0xAF, 0x00), RGBColor.init(0x5F, 0xAF, 0x5F), RGBColor.init(0x5F, 0xAF, 0x87), RGBColor.init(0x5F, 0xAF, 0xAF), RGBColor.init(0x5F, 0xAF, 0xD7), RGBColor.init(0x5F, 0xAF, 0xFF),
    RGBColor.init(0x5F, 0xD7, 0x00), RGBColor.init(0x5F, 0xD7, 0x5F), RGBColor.init(0x5F, 0xD7, 0x87), RGBColor.init(0x5F, 0xD7, 0xAF), RGBColor.init(0x5F, 0xD7, 0xD7), RGBColor.init(0x5F, 0xD7, 0xFF),
    RGBColor.init(0x5F, 0xFF, 0x00), RGBColor.init(0x5F, 0xFF, 0x5F), RGBColor.init(0x5F, 0xFF, 0x87), RGBColor.init(0x5F, 0xFF, 0xAF), RGBColor.init(0x5F, 0xFF, 0xD7), RGBColor.init(0x5F, 0xFF, 0xFF),
    RGBColor.init(0x87, 0x00, 0x00), RGBColor.init(0x87, 0x00, 0x5F), RGBColor.init(0x87, 0x00, 0x87), RGBColor.init(0x87, 0x00, 0xAF), RGBColor.init(0x87, 0x00, 0xD7), RGBColor.init(0x87, 0x00, 0xFF),
    RGBColor.init(0x87, 0x5F, 0x00), RGBColor.init(0x87, 0x5F, 0x5F), RGBColor.init(0x87, 0x5F, 0x87), RGBColor.init(0x87, 0x5F, 0xAF), RGBColor.init(0x87, 0x5F, 0xD7), RGBColor.init(0x87, 0x5F, 0xFF),
    RGBColor.init(0x87, 0x87, 0x00), RGBColor.init(0x87, 0x87, 0x5F), RGBColor.init(0x87, 0x87, 0x87), RGBColor.init(0x87, 0x87, 0xAF), RGBColor.init(0x87, 0x87, 0xD7), RGBColor.init(0x87, 0x87, 0xFF),
    RGBColor.init(0x87, 0xAF, 0x00), RGBColor.init(0x87, 0xAF, 0x5F), RGBColor.init(0x87, 0xAF, 0x87), RGBColor.init(0x87, 0xAF, 0xAF), RGBColor.init(0x87, 0xAF, 0xD7), RGBColor.init(0x87, 0xAF, 0xFF),
    RGBColor.init(0x87, 0xD7, 0x00), RGBColor.init(0x87, 0xD7, 0x5F), RGBColor.init(0x87, 0xD7, 0x87), RGBColor.init(0x87, 0xD7, 0xAF), RGBColor.init(0x87, 0xD7, 0xD7), RGBColor.init(0x87, 0xD7, 0xFF),
    RGBColor.init(0x87, 0xFF, 0x00), RGBColor.init(0x87, 0xFF, 0x5F), RGBColor.init(0x87, 0xFF, 0x87), RGBColor.init(0x87, 0xFF, 0xAF), RGBColor.init(0x87, 0xFF, 0xD7), RGBColor.init(0x87, 0xFF, 0xFF),
    RGBColor.init(0xAF, 0x00, 0x00), RGBColor.init(0xAF, 0x00, 0x5F), RGBColor.init(0xAF, 0x00, 0x87), RGBColor.init(0xAF, 0x00, 0xAF), RGBColor.init(0xAF, 0x00, 0xD7), RGBColor.init(0xAF, 0x00, 0xFF),
    RGBColor.init(0xAF, 0x5F, 0x00), RGBColor.init(0xAF, 0x5F, 0x5F), RGBColor.init(0xAF, 0x5F, 0x87), RGBColor.init(0xAF, 0x5F, 0xAF), RGBColor.init(0xAF, 0x5F, 0xD7), RGBColor.init(0xAF, 0x5F, 0xFF),
    RGBColor.init(0xAF, 0x87, 0x00), RGBColor.init(0xAF, 0x87, 0x5F), RGBColor.init(0xAF, 0x87, 0x87), RGBColor.init(0xAF, 0x87, 0xAF), RGBColor.init(0xAF, 0x87, 0xD7), RGBColor.init(0xAF, 0x87, 0xFF),
    RGBColor.init(0xAF, 0xAF, 0x00), RGBColor.init(0xAF, 0xAF, 0x5F), RGBColor.init(0xAF, 0xAF, 0x87), RGBColor.init(0xAF, 0xAF, 0xAF), RGBColor.init(0xAF, 0xAF, 0xD7), RGBColor.init(0xAF, 0xAF, 0xFF),
    RGBColor.init(0xAF, 0xD7, 0x00), RGBColor.init(0xAF, 0xD7, 0x5F), RGBColor.init(0xAF, 0xD7, 0x87), RGBColor.init(0xAF, 0xD7, 0xAF), RGBColor.init(0xAF, 0xD7, 0xD7), RGBColor.init(0xAF, 0xD7, 0xFF),
    RGBColor.init(0xAF, 0xFF, 0x00), RGBColor.init(0xAF, 0xFF, 0x5F), RGBColor.init(0xAF, 0xFF, 0x87), RGBColor.init(0xAF, 0xFF, 0xAF), RGBColor.init(0xAF, 0xFF, 0xD7), RGBColor.init(0xAF, 0xFF, 0xFF),
    RGBColor.init(0xD7, 0x00, 0x00), RGBColor.init(0xD7, 0x00, 0x5F), RGBColor.init(0xD7, 0x00, 0x87), RGBColor.init(0xD7, 0x00, 0xAF), RGBColor.init(0xD7, 0x00, 0xD7), RGBColor.init(0xD7, 0x00, 0xFF),
    RGBColor.init(0xD7, 0x5F, 0x00), RGBColor.init(0xD7, 0x5F, 0x5F), RGBColor.init(0xD7, 0x5F, 0x87), RGBColor.init(0xD7, 0x5F, 0xAF), RGBColor.init(0xD7, 0x5F, 0xD7), RGBColor.init(0xD7, 0x5F, 0xFF),
    RGBColor.init(0xD7, 0x87, 0x00), RGBColor.init(0xD7, 0x87, 0x5F), RGBColor.init(0xD7, 0x87, 0x87), RGBColor.init(0xD7, 0x87, 0xAF), RGBColor.init(0xD7, 0x87, 0xD7), RGBColor.init(0xD7, 0x87, 0xFF),
    RGBColor.init(0xD7, 0xAF, 0x00), RGBColor.init(0xD7, 0xAF, 0x5F), RGBColor.init(0xD7, 0xAF, 0x87), RGBColor.init(0xD7, 0xAF, 0xAF), RGBColor.init(0xD7, 0xAF, 0xD7), RGBColor.init(0xD7, 0xAF, 0xFF),
    RGBColor.init(0xD7, 0xD7, 0x00), RGBColor.init(0xD7, 0xD7, 0x5F), RGBColor.init(0xD7, 0xD7, 0x87), RGBColor.init(0xD7, 0xD7, 0xAF), RGBColor.init(0xD7, 0xD7, 0xD7), RGBColor.init(0xD7, 0xD7, 0xFF),
    RGBColor.init(0xD7, 0xFF, 0x00), RGBColor.init(0xD7, 0xFF, 0x5F), RGBColor.init(0xD7, 0xFF, 0x87), RGBColor.init(0xD7, 0xFF, 0xAF), RGBColor.init(0xD7, 0xFF, 0xD7), RGBColor.init(0xD7, 0xFF, 0xFF),
    RGBColor.init(0xFF, 0x00, 0x00), RGBColor.init(0xFF, 0x00, 0x5F), RGBColor.init(0xFF, 0x00, 0x87), RGBColor.init(0xFF, 0x00, 0xAF), RGBColor.init(0xFF, 0x00, 0xD7), RGBColor.init(0xFF, 0x00, 0xFF),
    RGBColor.init(0xFF, 0x5F, 0x00), RGBColor.init(0xFF, 0x5F, 0x5F), RGBColor.init(0xFF, 0x5F, 0x87), RGBColor.init(0xFF, 0x5F, 0xAF), RGBColor.init(0xFF, 0x5F, 0xD7), RGBColor.init(0xFF, 0x5F, 0xFF),
    RGBColor.init(0xFF, 0x87, 0x00), RGBColor.init(0xFF, 0x87, 0x5F), RGBColor.init(0xFF, 0x87, 0x87), RGBColor.init(0xFF, 0x87, 0xAF), RGBColor.init(0xFF, 0x87, 0xD7), RGBColor.init(0xFF, 0x87, 0xFF),
    RGBColor.init(0xFF, 0xAF, 0x00), RGBColor.init(0xFF, 0xAF, 0x5F), RGBColor.init(0xFF, 0xAF, 0x87), RGBColor.init(0xFF, 0xAF, 0xAF), RGBColor.init(0xFF, 0xAF, 0xD7), RGBColor.init(0xFF, 0xAF, 0xFF),
    RGBColor.init(0xFF, 0xD7, 0x00), RGBColor.init(0xFF, 0xD7, 0x5F), RGBColor.init(0xFF, 0xD7, 0x87), RGBColor.init(0xFF, 0xD7, 0xAF), RGBColor.init(0xFF, 0xD7, 0xD7), RGBColor.init(0xFF, 0xD7, 0xFF),
    RGBColor.init(0xFF, 0xFF, 0x00), RGBColor.init(0xFF, 0xFF, 0x5F), RGBColor.init(0xFF, 0xFF, 0x87), RGBColor.init(0xFF, 0xFF, 0xAF), RGBColor.init(0xFF, 0xFF, 0xD7), RGBColor.init(0xFF, 0xFF, 0xFF),
...
// Enhanced mapping from ANSI 256 colors to 16 colors based on Charmbracelet X
