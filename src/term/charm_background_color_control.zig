...
const Color = @import("charm_enhanced_color_conversion.zig").Color;
const RGBColor = @import("charm_enhanced_color_conversion.zig").RGBColor;
const RGBA = @import("charm_enhanced_color_conversion.zig").RGBA;

/// Terminal background and foreground color control based on Charmbracelet's x/ansi implementation
