//! Smart TUI Demo
//!
//! This demonstrates the new smart TUI components with progressive enhancement
...
pub fn main() !void {
    ...
    // Demo 1: Smart Notifications
    std.debug.print("Demo 1: Smart Notifications\n");
    std.debug.print("----------------------------\n");

    try tui.notifyInfo("Demo Started", "Testing smart notifications with progressive enhancement");
    ...
    // Demo 2: Smart Progress Bars
    std.debug.print("Demo 2: Smart Progress Bars\n");
    std.debug.print("---------------------------\n");

    const smart_progress = @import("widgets/smart_progress.zig");

    // Different progress bar styles
    const progress_styles = [_]smart_progress.SmartProgressBar.ProgressStyle{ .bar, .blocks, .gradient, .dots };
    ...
    // Final notification
    try tui.notifyCritical("Demo Complete", "All smart TUI features demonstrated!");
