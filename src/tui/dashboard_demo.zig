...
pub const DashboardDemo = struct {
    ...
    fn setupDashboard(self: *Self) !void {
        ...
        var stock_widget = Dashboard.DashboardWidget.init(
            &stock_chart,
            Dashboard.DashboardWidget.GridPosition{
                .row = 0,
                .col = 0,
                .span_rows = 1,
                .span_cols = 2,
        ...
        var system_widget = Dashboard.DashboardWidget.init(
            &system_chart,
            Dashboard.DashboardWidget.GridPosition{
                .row = 0,
                .col = 2,
        ...
        var sales_table = try DataTable.init(
            self.allocator,
            &headers,
            DataTable.Config{
        ...
        var table_widget = Dashboard.DashboardWidget.init(
            &sales_table,
            Dashboard.DashboardWidget.GridPosition{
                .row = 1,
                .col = 0,
        ...
        var network_sparkline = Sparkline.init(
            self.allocator,
            self.network_data,
            Sparkline.Config{
                .title = "Network I/O",
        ...
        var sparkline_widget = Dashboard.DashboardWidget.init(
            &network_sparkline,
            Dashboard.DashboardWidget.GridPosition{
                .row = 1,
                .col = 2,
        ...
        var pie_widget = Dashboard.DashboardWidget.init(
            &cpu_pie_chart,
            Dashboard.DashboardWidget.GridPosition{
                .row = 2,
                .col = 0,
        ...
        var memory_widget = Dashboard.DashboardWidget.init(
            &memory_chart,
            Dashboard.DashboardWidget.GridPosition{
                .row = 2,
                .col = 1,
    ...
    fn showWelcomeMessage(self: *Self) !void {
        ...
        try terminal.print("🚀 Enhanced TUI Dashboard Demo", tui.createStyle(
            terminal_mod.Colors.BRIGHT_CYAN,
            null,
            true
        ));
        ...
        try terminal.print("Terminal Capabilities Detected:", tui.createStyle(
            terminal_mod.Colors.YELLOW,
            null,
            true
        ));
        ...
        try terminal.print("Press any key to continue...", tui.createStyle(
    ...
    fn renderStatusBar(self: *Self, terminal_size: tui.TerminalSize) !void {
        ...
        try terminal.print("📊 Dashboard Demo", tui.createStyle(
            terminal_mod.Colors.BRIGHT_GREEN,
            terminal_mod.Colors.BLACK,
            true
        ));
        
        // Current page
        try terminal.moveTo(25, status_y);
        try terminal.printf("Page: {s}", .{@tagName(self.current_page)}, tui.createStyle(
            terminal_mod.Colors.WHITE,
            terminal_mod.Colors.BLACK,
            false
        ));
        ...
        try terminal.printf("Mode: {s}", .{@tagName(mode.graphics)}, tui.createStyle(
            terminal_mod.Colors.CYAN,
            terminal_mod.Colors.BLACK,
            false
        ));
        ...
        try terminal.print(shortcuts, tui.createStyle(
            terminal_mod.Colors.YELLOW,
            terminal_mod.Colors.BLACK,
            false
        ));
    ...
    fn renderNavigation(self: *Self, terminal_size: tui.TerminalSize) !void {
        ...
        // Clear line
        for (0..terminal_size.width) |_| {
            try terminal.print(" ", tui.createStyle(
                terminal_mod.Colors.WHITE,
                terminal_mod.Colors.BLUE,
                false
            ));
        }
        ...
        try terminal.print(title, tui.createStyle(
            terminal_mod.Colors.BRIGHT_WHITE,
            terminal_mod.Colors.BLUE,
            true
        ));
    }
    ...
    fn showSizeWarning(self: *Self, size: tui.TerminalSize) !void {
        ...
        try terminal.print("⚠️  Terminal Too Small", tui.createStyle(
            terminal_mod.Colors.YELLOW,
            null,
            true
        ));
...
fn generateTableData(allocator: std.mem.Allocator) ![][]DataTable.Cell {
    const products = [_][]const u8{
        "Widget Pro", "Gadget Max", "Tool Plus", "Device X", "System Y",
        "Platform Z", "Service A", "Product B", "Solution C", "Framework D"
    };
