...
pub const Chart = struct {
    ...
    fn drawPoint(self: *Self, image_data: []u8, width: u32, height: u32, x: u32, y: u32, color: Color) void {
        ...
        self.drawRect(image_data, width, height, 
                     x -| point_radius / 2, y -| point_radius / 2, 
                     point_radius, point_radius, color);
    }
    ...
    fn drawAxes(self: *Self, image_data: []u8, width: u32, height: u32, chart_area: Bounds, y_range: ChartData.Range) !void {
        // Draw X axis
        self.drawLine(image_data, width, height, 
                     chart_area.x, chart_area.y + chart_area.height,
    ...
    fn drawGrid(self: *Self, image_data: []u8, width: u32, height: u32, chart_area: Bounds) !void {
        ...
        for (1..grid_lines) |i| {
            ...
            self.drawLine(image_data, width, height,
                         x, chart_area.y,
                         x, chart_area.y + chart_area.height,
        ...
        for (1..grid_lines) |i| {
            ...
            self.drawLine(image_data, width, height,
                         chart_area.x, y,
                         chart_area.x + chart_area.width, y,
                         self.style.grid_color);
        }
    }
