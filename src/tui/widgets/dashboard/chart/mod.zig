...
pub const Chart = renderer.ChartRenderer;
pub const ChartType = base.ChartType;
pub const ChartData = base.ChartData;
...
pub fn createLineChart(allocator: std.mem.Allocator, series_name: []const u8, values: []const f64) Chart {
...
pub fn createMultiLineChart(allocator: std.mem.Allocator, title: []const u8, series_data: []const base.ChartData.Series) Chart {
    const chart_data = base.ChartData{
        .series = series_data,
        .x_labels = null,
        .y_range = null,
...
pub fn createAreaChart(allocator: std.mem.Allocator, series_name: []const u8, values: []const f64) Chart {
    const series = base.ChartData.Series{
        .name = series_name,
        .values = values,
        .color = null,
...
pub fn createSeries(name: []const u8, values: []const f64, color: ?base.Color, style: base.ChartData.Series.SeriesStyle) base.ChartData.Series {
    return base.ChartData.Series{
        .name = name,
        .values = values,
        .color = color,
        .style = style,
