...
/// Smart progress bar that adapts to terminal capabilities
pub const SmartProgressBar = struct {
    const Self = @This();
...
pub fn renderProgress(
    ...
    var progress_bar = SmartProgressBar.init(label, .bar);
