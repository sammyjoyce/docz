...
pub const NotificationDisplay = struct {
    ...
    pub fn show(self: *NotificationDisplay, 
               notification_type: NotificationType,
               title: []const u8,
               message: ?[]const u8,
               style: NotificationStyle) !void {
    ...
    fn showSystem(self: *NotificationDisplay,
                  notification_type: NotificationType,
                  title: []const u8,
    ...
    fn showDetailed(self: *NotificationDisplay,
                    notification_type: NotificationType,
                    title: []const u8,
                    message: ?[]const u8) !void {
    ...
    fn showMinimal(self: *NotificationDisplay,
                   notification_type: NotificationType,
                   title: []const u8,
                   message: ?[]const u8) !void {
    ...
    fn getStyledElements(self: *NotificationDisplay, 
                        notification_type: NotificationType, 
                        use_colors: bool) StyleElements {
        _ = self;
